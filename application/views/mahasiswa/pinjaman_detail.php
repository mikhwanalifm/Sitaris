<div class="container-fluid">
	...
	<div class="alert alert-success" role="alert">
  		<i class="fas fa-eye"></i> Detail Pinjaman
  	</div>
      ...
      <tr>
      <th width="400px">NOMOR HANDPHONE</th>
        <th><?php echo $dt->no_hp ?></th>
      </tr>
      <tr>
      <th width="400px">DURASI</th>
        <th><?php echo $dt->durasi ?></th>
      </tr>
  	...
  	<?php echo anchor('mahasiswa/pinjaman','<div class="btn btn-primary btn-sm">KEMBALI</div>')?>
</div>